			...
			<section className="mb-10">
				...
				<p className="text-gray-600 dark:text-gray-400 mb-4">
					{isZh
						...
						: 'While idle, clicking the close button (X) clears the displayed conversation and leaves a floating 🤖 button to reopen the reusable agent anytime. Clicking the launcher expands the panel directly, so reloading the page is not required.'}
				</p>
				<CodeEditor
					language="typescript"
